...
public static class ConfigureRoutingExtension
{
    ...
    private static void ConfigureRoutes(WebApplication app)
    {
        ...
        root.MapGet("/{id:int}",
                    async Task<Results<NotFound, Ok<CurrentVacationDto>>> (IVacationService routingService, int id) =>
                    {
        ...
        root.MapPost("/", async Task<CreatedAtRoute<VacationCreatedDto>> (
                         IVacationService routingService, CreateVacationDto route) =>
                     {
        ...
        root.MapPut("/{id:int}",
                    async Task<Results<NotFound, Ok>> (IVacationService  routingService, int id,
                                                       UpdateVacationDto route) =>
                    {
        ...
        root.MapDelete("/{id:int}",
                       async Task<Results<NotFound, NoContent>> (IVacationService routingService, int id) =>
                       {
